sap.ui.define([
	...
	return Controller.extend("me.wirries.coffeemonitor.coffeeui5.controller.App", {

		/**
		 * Called when a controller is instantiated and its View controls (if available) are already created.
		 * Can be used to modify the View before it is displayed, to bind event handlers and do other one-time
		 * initialization.
		 * @memberOf me.wirries.coffeemonitor.coffeeui5.view.App
		 */
		onInit: function () {
		 ...
		 * @memberOf me.wirries.coffeemonitor.coffeeui5.view.History
		 */
